  ...
  return (
    <section id="achievements" className="max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {achievements.map((a: Achievement, index: number) => {
          ...
          const linkProofs = (a.proofs || []).filter((p) => p.type === "link");
                ...
                <div className="mt-5 space-y-2">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {linkProofs.map((p, i) => (
                      ...
                      >
                        {p.label || "Open Link"}
                        {/* external link icon (SVG inline, like your Experience icons) */}
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 24 24"
